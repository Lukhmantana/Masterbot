...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('🤖 Updates', url='https://t.me/TORRENTTZ_MOVIEv2')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('ɢʀᴏᴜᴘ', url='https://t.me/TORRENTZ_V2')
            ],[
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        if message.command[1] != "subscribe":
            ...
            btn.append([InlineKeyboardButton("🌀 ʀᴇꜰʀᴇꜱʜ 🌀", callback_data=f"{pre}#{file_id}")])
    ...
    if settings is not None:
        buttons = [
            [
                ...
                InlineKeyboardButton(
                    'Single' if settings["button"] else 'Single',
                    callback_data=f'setgs#button#{settings["button"]}#{grp_id}',
                ),
            ],
            [
